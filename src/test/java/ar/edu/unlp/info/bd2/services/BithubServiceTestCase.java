...
public abstract class BithubServiceTestCase<T> {
  ...
  public void testCreateBranchAndCommit() {
    ...
    File file1 = this.service.createFile( "Main.java", "System.out.println(\"Hello world\");");
    ...
    File file2 = this.service.createFile("Main.py", "print(\"Hello world\")");
  ...
  void testCreateReview() throws BithubException {
    ...
    File fileInMasterBranch =
        this.service.createFile("Main.java", "System.out.println(\"Hello wrld\");");
    this.service.createCommit(
    ...
    assertEquals(1, fileReview.getLineNumber());
